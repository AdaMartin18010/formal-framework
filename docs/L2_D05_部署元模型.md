...
- **本层细化**：本 L2 元模型为部署域的基础抽象；具体标准与 DSL 见 L3。
- **下游标准**：[L3_D05 部署标准模型](L3_D05_部署标准模型.md)；对象/属性/不变式映射详情见 [L2↔L3 映射总表 2.4 节（部署）](formal-model/alignment-L2-L3-matrix.md#24-部署d05)。
...
- **标准与证据**：本模型与 ISO/IEC/IEEE 15288/12207 生命周期过程、L3_D05 部署标准及 L3_D09 CI/CD 对应。参见 [权威对标总索引](reference/AUTHORITY_ALIGNMENT_INDEX.md) 第 2 节、[evidence/STD-15288](evidence/STD-15288.md)、[evidence/STD-12207](evidence/STD-12207.md)。
- **课程映射**：部署/发布对应 LEARNING_PATHS 云原生专项、L3_D05/L3_D09；认证见 CNCF CGOA、CAPA 等（AUTHORITY_ALIGNMENT_INDEX 第 4 节）。
