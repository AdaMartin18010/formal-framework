...
- [可观测性DSL草案](#可观测性dsl草案)
  ...
  - [2. 基本语法结构](#2-基本语法结构)
  - [3. 关键元素](#3-关键元素)
    - [3.1 指标收集 (Metrics)](#31-指标收集-metrics)
    - [3.2 日志收集 (Logging)](#32-日志收集-logging)
    - [3.3 分布式追踪 (Tracing)](#33-分布式追踪-tracing)
  - [4. 高级功能](#4-高级功能)
    - [4.1 自定义指标](#41-自定义指标)
    - [4.2 日志解析规则](#42-日志解析规则)
    - [4.3 追踪采样策略](#43-追踪采样策略)
  - [5. 与主流标准映射](#5-与主流标准映射)
    - [5.1 Kubernetes](#51-kubernetes)
    - [5.2 Docker Compose](#52-docker-compose)
    - [5.3 Helm Charts](#53-helm-charts)
  - [6. 实践示例](#6-实践示例)
    - [6.1 微服务可观测性栈](#61-微服务可观测性栈)
    - [6.2 云原生应用可观测性](#62-云原生应用可观测性)
  - [7. 最佳实践](#7-最佳实践)
    - [7.1 指标设计](#71-指标设计)
    - [7.2 日志管理](#72-日志管理)
    - [7.3 追踪策略](#73-追踪策略)
