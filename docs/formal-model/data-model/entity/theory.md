...
- **L2/L3 映射**：实体建模属 [L2_D02 数据元模型](../../../L2_D02_数据元模型.md)、[L3_D02 数据标准模型](../../../L3_D02_数据标准模型.md) 之数据建模子域；对象/属性/不变式对齐见 [L2↔L3 映射总表（数据）](../../alignment-L2-L3-matrix.md)。
- **标准与课程**：数据与实体建模相关标准（ISO/IEC 25012、UML/ER、Prisma/TypeORM 等）及名校课程（如 CMU 15-445、Berkeley INFO 202）与 L2_D02/L3_D02 知识点对照见 [AUTHORITY_STANDARD_COURSE_L2L3_MATRIX](../../../reference/AUTHORITY_STANDARD_COURSE_L2L3_MATRIX.md) 与 [AUTHORITY_ALIGNMENT_INDEX](../../../reference/AUTHORITY_ALIGNMENT_INDEX.md) 第 2–3 节。
