...
- **L2/L3 映射**：本理论对应 [L2_D02 数据元模型](../../L2_D02_数据元模型.md)、[L3_D02 数据标准模型](../../L3_D02_数据标准模型.md)；对象/属性/不变式对齐见 [L2↔L3 映射总表 2.2 节（数据）](../alignment-L2-L3-matrix.md#22-数据d02)。
- **标准与课程**：数据模型相关标准（ISO/IEC 25012、UML/ER 等）及名校课程与 L2_D02/L3_D02 知识点对照见 [AUTHORITY_STANDARD_COURSE_L2L3_MATRIX](../../reference/AUTHORITY_STANDARD_COURSE_L2L3_MATRIX.md) 与 [AUTHORITY_ALIGNMENT_INDEX](../../reference/AUTHORITY_ALIGNMENT_INDEX.md) 第 2–3 节。
