...
- [功能建模理论递归补全](#功能建模理论递归补全)
  - [目录（Table of Contents）](#目录table-of-contents)
  - [1. 功能建模的AST与递归结构](#1-功能建模的ast与递归结构)
    - [1.1 核心组件结构](#11-核心组件结构)
      - [业务逻辑节点](#业务逻辑节点)
      - [规则引擎节点](#规则引擎节点)
      - [状态机节点](#状态机节点)
      - [工作流节点](#工作流节点)
    - [1.2 AST递归遍历机制](#12-ast递归遍历机制)
  - [2. 类型推理与业务逻辑验证机制](#2-类型推理与业务逻辑验证机制)
  - [3. 推理引擎与自动化执行](#3-推理引擎与自动化执行)
  - [4. 异常与补偿机制](#4-异常与补偿机制)
  - [5. AI辅助与工程自动化实践](#5-ai辅助与工程自动化实践)
  - [6. 典型开源项目源码剖析](#6-典型开源项目源码剖析)
  - [7. 全链路自动化与可证明性递归](#7-全链路自动化与可证明性递归)
  - [8. AI驱动的智能功能建模](#8-ai驱动的智能功能建模)
    - [8.1 业务逻辑自动生成](#81-业务逻辑自动生成)
    - [8.2 规则引擎智能优化](#82-规则引擎智能优化)
    - [8.3 状态机自动推理](#83-状态机自动推理)
    - [8.4 工作流自动编排](#84-工作流自动编排)
  - [9. 复杂业务场景递归建模](#9-复杂业务场景递归建模)
    - [9.1 微服务业务逻辑建模](#91-微服务业务逻辑建模)
    - [9.2 复杂规则引擎建模](#92-复杂规则引擎建模)
    - [9.3 分布式状态机建模](#93-分布式状态机建模)
...
- **L2/L3 映射**：本理论对应 [L2_D03 功能元模型](../../L2_D03_功能元模型.md)、[L3_D03 功能标准模型](../../L3_D03_功能标准模型.md)；对象/属性/不变式对齐见 [L2↔L3 映射总表](../alignment-L2-L3-matrix.md)。
- **标准与课程**：功能与业务流程建模相关标准（BPMN、UML 等）及名校课程与 L2_D03/L3_D03 知识点对照见 [AUTHORITY_STANDARD_COURSE_L2L3_MATRIX](../../reference/AUTHORITY_STANDARD_COURSE_L2L3_MATRIX.md) 与 [AUTHORITY_ALIGNMENT_INDEX](../../reference/AUTHORITY_ALIGNMENT_INDEX.md) 第 2–3 节。
