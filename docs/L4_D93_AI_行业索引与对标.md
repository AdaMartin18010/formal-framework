...
**本节要点**：（1）AI 基础设施核心对象（数据管道、特征库、模型训练/服务、MLOps）与 L3 模型映射；（2）术语对齐与标准/项目映射矩阵；（3）开源项目（MLflow、Kubeflow、Feast 等）与 L3_D02/D04/D06/D09 对应；（4）技术栈详细映射与 MLOps 成熟度。  
...
**5 分钟版**：§4 标准/项目映射矩阵 + [templates/TEMPLATE_映射矩阵](templates/TEMPLATE_映射矩阵.md)；权威对标见 [AUTHORITY_ALIGNMENT_INDEX 第 5 节](reference/AUTHORITY_ALIGNMENT_INDEX.md#5-行业与-l4-索引映射)。

## 本行业 ↔ L2/L3 映射

| 本行业（AI 基础设施） | L2 元模型 | L3 标准模型 | 说明 |
| ---------------------- | --------- | ----------- | ---- |
| 数据管道、特征库 | L2_D02 数据、L2_D03 功能 | [L3_D02 数据](L3_D02_数据标准模型.md)、[L3_D03 功能](L3_D03_功能标准模型.md) | Feast、数据验证 |
| 分布式训练/推理、编排 | L2_D04 运行时 | [L3_D04 运行时](L3_D04_运行时标准模型.md) | 容器、GPU 调度 |
| 模型服务、API | L2_D01 交互、L2_D04 | [L3_D01 交互](L3_D01_交互标准模型.md)、[L3_D04 运行时](L3_D04_运行时标准模型.md) | TensorFlow Serving、版本 |
| MLOps、流水线 | L2_D05 部署、L2_D08 测试 | [L3_D09 CI/CD](L3_D09_CICD标准模型.md)、[L3_D08 测试](L3_D08_测试标准模型.md) | 自动化训练/部署、门禁 |
| 监控与可观测 | L2_D06 监控 | [L3_D06 监控](L3_D06_监控标准模型.md) | 指标、模型漂移 |
